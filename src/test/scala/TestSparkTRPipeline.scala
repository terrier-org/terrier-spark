...
import org.terrier.spark.ml.Measure


class TestSparkTRPipeline extends FlatSpec {
  
  val indexref = IndexRef.of("/Users/craigm/wt2g_index/index/data.properties")
  val topics = "/Users/craigm/wt2g_index/topicsqrels/small_web/topics.401-450"
  val qrels = "/Users/craigm/wt2g_index/topicsqrels/small_web/qrels.trec8"
  val props = Map(
...
//      .setEvaluator(new RankingEvaluator(Measure.P, 5))
  ...
  "WT2G" should "work for retrieval" in {
    ...
    val trainingTopicIter = TopicSource.extractTRECTopics(topics)
